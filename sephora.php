...
<h1 class="title" style="margin-top: 10%">SEPHORA COLLECTION</h1>

<div class="box-container">

   <?php
      $select_products = mysqli_query($conn, "SELECT * FROM `skin_mask` WHERE brand LIKE '%sephora%'") or die('query failed');

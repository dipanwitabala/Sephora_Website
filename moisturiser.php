...
<h1 class="title" style="margin-top: 10%">BATHING MOISTURISER</h1>
<div class="box-container">

   <?php
      $select_products = mysqli_query($conn, "SELECT * FROM `skin_mask` WHERE details LIKE '%bath moisturizer%'") or die('query failed');

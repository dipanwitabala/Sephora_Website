  ...
  <div class="container mb-5 ">
        ...
        <p style="color: white">Spoilt for choice, from global to cult brands</p>
           <div class="option" style="margin-left: -100px;">
            ...
            <a  href="sephora.php"><img class="face-image" role="button" src="image/Sephora.jpg"></a>

            <a href="dior.php"><img class="face-image" role="button" src="image/dior.png"></a>
            <a href="huda.php"><img class="face-image" role="button" src="image/HUDA.png"></a>
           <a href="ola.php" ><img class="face-image" role="button" src="image/ola.png"></a>
            <a  href="rare.php"><img class="face-image" role="button" src="image/rare.jpg"></a>
        
      
        </div>
        <div class="d container-fluid mx-5">
            
            <a  href="sephora.php"><button class="face-button" > SEPHORA</button></a>
           <a href="dior.php"><button class="face-button" > DIOR </button></a>
              <a href="huda.php"><button class="face-button" > HUDA BEAUTY </button></a>
           <a href="ola.php" ><button class="face-button" > OLAPLEX</button></a>
              <a  href="rare.php"><button class="face-button" > RARE BEAUTY </button></a>
        
      
        </div>
         </div>        <!-- container for all products-->
       
                     
        <section class="products">

<h1 class="title" style="margin-top: 10%">OLAPLEX</h1>

<div class="box-container">

   <?php
      $select_products = mysqli_query($conn, "SELECT * FROM `skin_mask` WHERE brand LIKE 'ola%'") or die('query failed');

...
<section class="heading">
    <h3>search page</h3>
    <p> <a href=".php">home</a> / search </p>
</section>

<section class="search-form">
    <form action="" method="POST">
        <input type="text" class="box" placeholder="search products..." name="search_box">
        <input type="submit" class="delete-btn" value="search" name="search_btn">
    </form>
</section>
   ...
   <div class="box-container">
      ...
      <?php
        if(isset($_POST['search_btn'])){
         ...
         $select_products = mysqli_query($conn, "SELECT * FROM `skin_mask` WHERE name LIKE '%" . $search_box ."%'") or die('query failed');
         if(mysqli_num_rows($select_products) > 0){
            while($fetch_products = mysqli_fetch_assoc($select_products)){
      ?>
      <form  action="searchresult.php"method="POST" class="box">

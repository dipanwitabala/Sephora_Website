                                                        ...
                                                        <ul class="navbar-nav ">
                                                            ...
                                                            <li class="nav-item ">
                                                                ...
                                                                <ul class=" dropdown-menu" >
                                                                    ...
                                                                    <li><a class="dropdown-item" href="moisturiser.php"  role="button">Moisturiser</a></li>
...
<h1 class="title" style="margin-top: 10%">BATH & SHOWER</h1>
<div class="box-container">

   <?php
      $select_products = mysqli_query($conn, "SELECT * FROM `skin_mask` WHERE details LIKE '%bath%'") or die('query failed');

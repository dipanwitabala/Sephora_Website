...
<h1 class="title">Facial Cleanser & Exfoliator</h1>

<div class="box-container">

   <?php
      $select_products = mysqli_query($conn, "SELECT * FROM `skin_mask` WHERE details LIKE '%cleanser%'or'%Exfoliator%'") or die('query failed');
